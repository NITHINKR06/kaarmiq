...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen p-6 flex items-center justify-center bg-gray-100 dark:bg-gray-800">
      <div className="w-auto h-full mx-auto bg-white rounded-lg shadow-lg dark:bg-gray-900">
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="hidden md:block bg-gray-200 dark:bg-gray-700 p-8">
            ...
            <p className="text-center text-gray-600 dark:text-gray-300">
              ...
              <p className="mb-6 text-gray-600 dark:text-gray-300">Start for free</p>
            </p>
            ...
            <form onSubmit={onSignup}>
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full p-2 mt-2 border rounded-lg dark:bg-gray-800 dark:text-white dark:border-gray-600"
                />
              </div>
                ...
                <div className="flex items-center mt-3 gap-4">
                  <label className="relative flex items-center cursor-pointer group">
                    <input
                      ...
                      onChange={() => setUser({ ...user, role: "employee" })}
                      className="hidden peer"
                    />
                    <div className="w-5 h-5 rounded-full border-2 border-gray-300 group-hover:border-blue-400 peer-checked:border-blue-600 peer-checked:bg-blue-600 transition-all duration-300">
                      <div className="w-3 h-3 bg-transparent rounded-full m-auto peer-checked:bg-white transition-all duration-300"></div>
                    </div>
                    <span className="ml-3 text-sm font-semibold text-gray-800 dark:text-white group-hover:text-blue-500 transition-all duration-300">
                      Employee
                    </span>
                  </label>
                  <label className="relative flex items-center cursor-pointer group">
              ...
              <div className="flex text-center justify-center items-center pb-3">
                <hr className="w-30" /> &nbsp;&nbsp;or&nbsp;&nbsp; <hr className="w-30" />
              </div>

              <div className="flex items-center justify-center gap-3.5 mb-6">
                <button className="flex w-full items-center justify-center gap-3.5 p-2 border border-gray-300 rounded-lg dark:border-gray-600 dark:text-white hover:bg-opacity-50">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
