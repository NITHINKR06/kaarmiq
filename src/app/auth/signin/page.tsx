...
// this below is for the login form after user completed this sign up form
    ...
    <div>
      <ToastContainer/>
        <div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-900">
          <div className="w-full max-w-4xl rounded-lg border bg-white shadow-lg dark:bg-gray-800">
            <div className="flex flex-wrap items-center">
              <div className="hidden xl:block xl:w-1/2">
                <div className="px-16 py-12 text-center">
                  <p className="mt-4 text-lg text-gray-700 dark:text-gray-300">
                    Sign to start your journey with us
                  </p>
                  <svg
                      width="350"
                      height="350"
              ...
              <div className="w-full xl:w-1/2 xl:border-l ">
                  ...
                  {/* <form onSubmit={onLogin}> */}
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        className="w-full rounded-lg border bg-transparent py-4 pl-6 pr-10 text-black focus:border-primary dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                      />
                    </div>
                    ...
                    <button
                      ...
                      className={`w-full cursor-pointer rounded-lg border bg-primary p-4 text-white transition ${
                        buttonDisabled || loading ? "opacity-50 cursor-not-allowed" : "hover:bg-opacity-90"
                      }`}
                    >
                      Sign In
                    </button>

                    <div className="flex text-center justify-center items-center pb-3 pt-2">
