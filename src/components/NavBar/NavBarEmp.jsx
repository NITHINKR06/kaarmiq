        ...
        <div className="relative hidden md:flex items-center group">
          ...
          <div className="absolute right-0 mt-64 z-50 hidden bg-white dark:bg-gray-700 rounded-lg shadow-md w-48 group-hover:block transition-all duration-200 ease-in-out">
            ...
            <ul className="py-2 text-gray-700 dark:text-gray-300">
              <li>
                <Link href="/emp/profile" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 rounded">
                  Dashboard
                </Link>
              </li>
              <li>
                <Link href="/emp/settings" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 rounded">
                  Settings
                </Link>
              </li>
              <li>
