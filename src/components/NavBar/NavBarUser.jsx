            ...
            if (item === "Services") {
              return (
                <div key={item} className="relative group">
                  <span className="text-gray-700 dark:text-gray-300 flex items-center space-x-2 text-lg cursor-pointer">
                    {/* {icon} */}
                    <span>{item}</span>
                  ...
                  {/* Dropdown */}
                  <div className="absolute -left-10 hidden group-hover:block bg-white dark:bg-gray-800 rounded-lg shadow-md mt-1 w-48 z-50">
                    <ul className="py-2 text-gray-700 dark:text-gray-300">
                      <li>
                        <Link href="/services/design" className="block px-4 py-2 hover:bg-white dark:hover:bg-gray-600 rounded">
                          Design
                        </Link>
                      </li>
                      <li>
                        <Link href="/services/development" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 rounded">
                          Development
                        </Link>
                      </li>
                      <li>
                        <Link href="/services/marketing" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 rounded">
                          Marketing
                        </Link>
                      </li>
                    </ul>
