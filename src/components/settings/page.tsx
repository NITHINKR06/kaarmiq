...
const Settings = () => {
  ...
  const [employee, setEmployee] = useState<User | null>(null); // To store user data
  ...
  // this is for get login employee details
  useEffect(() => {
  ...
  const handleSubmit = async (e:any) => {
    ...
    try {
        await axios.put("/api/employee/empupdate", {
            empId: employee?._id,
            updates: employee,
        });
  ...
  // Handler to update the experience state
  const handleExperienceChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    const value = event.target.value;
    const numericValue = value === "" ? "" : Math.max(0, Math.min(30, parseInt(value, 10)));
                ...
                <form action="#">
                  ...
                  <div className="mb-5.5">
                    <label
                      ...
                      htmlFor="JobRole"
                    >
                      Job Role {`//TODO: jobrole is not done get the role and update that`}
                    </label>
                    <select
                      className="w-full rounded border border-stroke bg-gray px-4.5 py-3 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                      name="JobRole"
                    ...
                    {selectedRole === "others" && (
                      <input
                        className="mt-3 w-full rounded border border-stroke bg-gray px-4.5 py-3 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                        type="text"
                        name="CustomRole"
                        id="CustomRole"
                  ...
                  <div className="mb-5.5">
                    ...
                    <input
                      ...
                      name="Experience"
                      id="Experience"
                      placeholder="Enter your experience (1-30 years)"
