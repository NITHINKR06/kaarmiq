...
export default function ContactUs() {
  return (
    <div className=" bg-gray-50 dark:bg-gray-900 flex items-center justify-center lg:px-16">
      <div className="max-w-7xl mt-29 mx-auto flex flex-col lg:flex-row bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden">
        {/* Left Side - Hero Content */}
        <div className="flex-1 bg-gradient-to-br from-blue-500 to-white text-white p-8 lg:p-16">
          <h2 className="text-3xl lg:text-5xl font-bold">Let’s Talk</h2>
            ...
            <li className="flex items-center">
              ...
              >
                <path
                  ...
                  d="M3 10h11M9 21H3M21 21h-6M21 3H9m0 18v-6M9 3v6M9 3h6"
                />
              </svg>
              <span>Email us at kaarmiqofficial@gmail.com</span>
            </li>
            <svg
                  width="350"
                  height="350"
        ...
        <div className="flex-1 lg:p-16">
          <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6">
            Contact Us
          </h3>

          <div className="w-full mb-5.5">{/* full Name */}
            <label
          ...
          <div className="mb-5.5">{/* Email */}
            ...
            <div className="text-right">
              <button
                type="submit"
                className="px-6 py-3 text-sm font-medium text-white bg-blue-600 rounded-lg shadow-md hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800"
              >
                Send Message
              </button>
            </div>
