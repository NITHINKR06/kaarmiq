...
const DropdownUser = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        console.log(response,'this is from dropdownuser')
  ...
  // Cancel logout action and close the modal
  ...
  return (
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      {isModalOpen && (
        <div
          className="fixed bg-black inset-0 z-50 flex items-center justify-center bg-opacity-50 mt-80"
        >
          {/* Modal Box */}
